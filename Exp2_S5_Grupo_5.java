package exp2_s5_grupo_5;

import java.util.Scanner;

public class Exp2_S5_Grupo_5 {

    //establezco mi primera variable estatica
    static int totalEntradas = 0;

    //constructor que me incrementa el contador cada vez que sea crea una entrada 
    public Exp2_S5_Grupo_5() {
        totalEntradas++;
    }

    public static int getTotalEntradas() { //modo estatico para acceder al total de entradas
        return totalEntradas;
    }
    //establezco mi segunda variable estatica, para calcular la cantidad de asientos disponibles.

    static int asientosDisponibles = 100;

    public static int restar(int asientosDisponibles, int totalEntradas) {
        int restar = asientosDisponibles - totalEntradas;
        return restar;
    }

    //establezco mi tercera variable estatica para calcular el porcentaje de ocupación del teatro
    public static int porcentajeOcupacion(int totalEntradas, int asientosDisponibles) {
        int porcentajeOcupacion = (totalEntradas * 100) / asientosDisponibles;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El total de entradas vendidas es: " + Exp2_S5_Grupo_5.getTotalEntradas());
        System.out.println("La cantidad de asientos disponibles es: " + Exp2_S5_Grupo_5.restar(asientosDisponibles, totalEntradas));
        System.out.println("El porcentaje de ocupación del teatro Moro es de: " + Exp2_S5_Grupo_5.porcentajeOcupacion(totalEntradas, asientosDisponibles) + "%");
